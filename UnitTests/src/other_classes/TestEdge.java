...
public class TestEdge implements Comparable<TestEdge>{

	private TestPoint start, end;
	private TestPoint upper, lower;
	
	
	public TestEdge(TestPoint start, TestPoint end){
		this.start = start;
		this.end = end;
		setUpperAndLower();
	...
	public TestPoint getStart(){
		return start;
	}
	
	public TestPoint getEnd(){
		return end;
	}
	...
	public TestPoint getUpper(){
		return upper;
	}
	
	public TestPoint getLower(){
		return lower;
	}
	
	public void changeUpper(TestPoint newUpper){
		upper = newUpper;
	}
	...
	public boolean isSmallerThan(TestEdge segment, int sweep_y){
	...
	//Denna används för att avgöra vilken sida av ett annat segment ett segment ska sättas in i i statusen.
		...
		public int compareTo(TestEdge arg0) {
